...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  >
    ...
    <Text
      as={typeof content === "string" ? "p" : "div"}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <AnimatedContainer direction="left" delay={0.2}>
              <div className="order-2 lg:order-1">
                <Text
                  as="h6"
                  className="text-sm font-semibold text-blue-700 uppercase tracking-wider mb-2"
                >
                  Let&apos;s Talk Business
                </Text>
                <Text
                ...
                <Text className="text-base text-gray-600 mb-8 leading-relaxed max-w-lg">
                  Are you ready to launch a groundbreaking app, refine your
                  digital strategy, or deploy powerful AI agents? Fill out the
        ...
        <Container className="py-12 md:py-16">
          <div className="text-center mb-10">
            ...
            <Text className="text-gray-600 max-w-xl mx-auto mt-2">
              Connect with us through our physical address, phone, email, or

...
const HeadContent = () => {
  return (
    <section className="mb-8 w-full rounded-3xl p-8 lg:p-20 bg-gradient-to-r from-[#FFF2DA] to-[#FFDAA4] overflow-hidden">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-16">
        ...
        >
          <div className="space-y-6">
            <div>
              <Text
                as="h1"
                className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight text-left"
              >
                Build. Launch. Grow.
              </Text>
            </div>
            ...
            <Text className="text-gray-600 text-base lg:text-lg leading-relaxed text-left">
              End-to-End solutions to scale your business smarter and faster
            </Text>
        ...
        >
          <div className="w-full">
            ...
            <div className="rounded-3xl p-8 lg:p-12 flex items-center justify-center min-h-[400px] ">
              <Image
                src="/images/ServicesChat.png"

  ...
  return (
    <section>
              ...
              >
                <div className="flex flex-col justify-center items-start gap-2">
                  ...
                  <Text className="text-sm text-primary/70 text-left max-w-sm">
                    ...
                    <br /> Connect with us and start your digital empire.
                  </Text>
                ...
                <div>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between items-start">
                      <Text as="h5" className="text-lg font-semibold">
                        GitHub
                      </Text>
                      <Text className="text-xs text-primary/70 max-w-[220px] text-left">
                        GitHub enables collaborative coding and seamless version
                        control.{" "}
                      </Text>
                    </div>
                  </ColorfulCard>
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between items-start">
                      ...
                      <Text className="text-xs text-primary/70 max-w-[220px] text-left">
                        OpenAI creates advanced AI to power smarter applications
                      </Text>
                    </div>
                  </ColorfulCard>
                  <ColorfulCard
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between items-start">
                      ...
                      <Text className="text-xs text-primary/70 max-w-[220px] text-left">
                        AWS powers scalable, secure cloud solutions for every
                        business.
                      </Text>
                    </div>
                  </ColorfulCard>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start w-full gap-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-1">
                    <div>
                      <Text
                        as="h4"
                        className="text-lg text-left font-semibold mb-4"
                      >
                        Pages
                      </Text>
      ...
      <div className="w-full bg-sky-100 h-10 mb-5">
        <Container className="max-w-6xl px-20 mx-0">
          <Text as="h5" className="text-left  text-xs pt-3">
